...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/payments/master/_listings/clover/apis.md
...
- name: ' - Create a payment record on an order'
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/payments/master/_listings/clover/v3merchantsmidordersorderidpayments-post-openapi.md
- name: ' - Get all payments'
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/payments/master/_listings/clover/v3merchantsmidpayments-get-openapi.md
- name: ' - Get a single payment'
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/payments/master/_listings/clover/v3merchantsmidpaymentspayid-get-openapi.md
- name: ' - '
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/payments/master/_listings/clover/v3merchantsmidpaymentspayid-post-openapi.md
- name: ' - Get all payments for an order'
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/payments/master/_listings/clover/v3merchantsmidordersorderidpayments-get-openapi.md
- name: ' - Get all payments under an employee'
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/payments/master/_listings/clover/v3merchantsmidemployeesempidpayments-get-openapi.md
- name: ' - Get a single payment'
  x-api-slug: v3merchantsmidpaymentspayid-get
  description: Get a single payment.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/clover-logo.png
